...
bool operator!=(const String &str1, const String &str2)
{
    if (str1.data() == nullptr || str2.data() == nullptr)
        throw std::invalid_argument("Exception in operato==(const String, const String): arg = nullptr.");
...
bool operator!=(const String &str1, const char *str2)
{
    if (str1.data() == nullptr || str2 == nullptr)
        throw std::invalid_argument("Exception in operato==(const String, const char): arg = nullptr.");
...
bool operator!=(const char *str1, const String &str2)
{
    if (str1 == nullptr || str2.data() == nullptr)
        throw std::invalid_argument("Exception in operato==(const char, const String): arg = nullptr.");
...
{
    if (str1.data() == nullptr || str2 == nullptr)
        throw std::invalid_argument("Exception in operato==(const String, char): arg = nullptr.");
    size_t len1{str1.size()}, len2{strlen(str2)};
    const char *_s1 = str1.data();
...
{
    if (str1 == nullptr || str2.data() == nullptr)
        throw std::invalid_argument("Exception in operato==(char, const String): arg = nullptr.");
    size_t len1{strlen(str1)}, len2{str2.size()};
